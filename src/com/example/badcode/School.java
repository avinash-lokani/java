...
import com.example.solidprinciples.StudentDetails;


import java.util.ArrayList;
import java.util.List;

public class School implements Classification{
    ...
    public static void main(String[] args){
        ...
        int[] classPercent = student.classPercentage(marksList,noOfSubjects);
